...
void loop () {
  ...
  if (buttonStateD != previousStateD && buttonStateD == LOW) {
    triggerLEDStripD();
  } 
  previousStateD = buttonStateD;
}

void triggerLEDStripA(){
  colorWipe(strip.Color(200, 40, 0), 10, 60);
  delay(200);
  colorWipe(strip.Color(0,0,0), 10, 60);
}

void triggerLEDStripB(){
  colorWipe(strip.Color(200, 200, 0), 10, 45);
  delay(200);
  colorWipe(strip.Color(0,0,0) ,10, 45);
}

void triggerLEDStripC(){
  colorWipe(strip.Color(100, 0, 200), 10, 30);
  delay(200);
  colorWipe(strip.Color(0,0,0),10, 30);
}

void triggerLEDStripD(){
  colorWipe(strip.Color(0, 200, 200), 10, 15);
  delay(200);
  colorWipe(strip.Color(0, 0, 0),10, 15);
}
